...
const STR = {
  ...
  /* v1.5: النظام البيئي */
  'toolbar.grab': ['🌐 فحص صفحة', '🌐 Scan page', '🌐 Sayfa tara'],
  'toolbar.grabTitle': ['فحص صور وفيديوهات وملفات صفحة ويب', 'Scan a webpage for images, videos and files', 'Sayfadaki görüntü, video ve dosyaları tara'],
  'grab.title': ['🌐 فحص صفحة — Site Grabber', '🌐 Page scan — Site Grabber', '🌐 Sayfa tarama — Site Grabber'],
  'grab.urlPh': ['https://example.com/gallery', 'https://example.com/gallery', 'https://example.com/gallery'],
  'grab.scan': ['🔍 فحص', '🔍 Scan', '🔍 Tara'],
  'grab.scanning': ['جارٍ جلب الصفحة وفحصها...', 'Fetching and scanning page...', 'Sayfa alınıyor ve taranıyor...'],
  'grab.hint': ['أدخل رابط صفحة لفحص صورها وفيديوهاتها وملفاتها', 'Enter a page URL to scan its images, videos and files', 'Görüntü, video ve dosyaları taramak için bir sayfa URL\'si girin'],
  'grab.found': ['🎬 {v} • 🖼️ {i} • 📦 {f}', '🎬 {v} • 🖼️ {i} • 📦 {f}', '🎬 {v} • 🖼️ {i} • 📦 {f}'],
  'grab.videos': ['🎬 فيديوهات', '🎬 Videos', '🎬 Videolar'],
  'grab.images': ['🖼️ صور', '🖼️ Images', '🖼️ Görüntüler'],
  'grab.files': ['📦 ملفات', '📦 Files', '📦 Dosyalar'],
  'grab.none': ['لا يوجد', 'None found', 'Bulunamadı'],
  'grab.download': ['⬇ تحميل المحدد', '⬇ Download selected', '⬇ Seçilenleri indir'],
  'grab.close': ['إغلاق', 'Close', 'Kapat'],
  'grab.queued': ['أضيف {n} عنصراً للتحميل', '{n} items queued', '{n} öğe kuyruğa alındı'],
  'video.cookies': ['🔒 تسجيل الدخول من متصفح (للمحتوى المحمي)', '🔒 Use browser login (for protected content)', '🔒 Tarayıcı girişini kullan (korunan içerik)'],
  'video.cookiesNone': ['بدون', 'None', 'Yok'],
  'data.title': ['🗄️ البيانات والنسخ الاحتياطي (5.4)', '🗄️ Data & backup (5.4)', '🗄️ Veri ve yedek (5.4)'],
  'data.export': ['📤 تصدير نسخة JSON', '📤 Export JSON backup', '📤 JSON yedeği dışa aktar'],
